...
BLOCKED_SITES_PATH = "blocked_sites.txt"
    ...
    if not is_admin():
        ...
        try:
            with open(BLOCKED_SITES_PATH, "r") as blocked_file:
                print("[DEBUG] Încep citirea blocked_sites.txt...")
                blocked_sites = blocked_file.readlines()
        except FileNotFoundError:
            print("Error: File not found")
        except PermissionError:
            print("Error: You don't have permissions to modify")
        except IOError:
            print("Error: Can not read the file!")
        ...
        try:
            ...
            with open(HOSTS_PATH, "a") as hosts_file:
                print("[DEBUG] Scriere în fișierul hosts...")
